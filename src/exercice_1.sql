...
INSERT INTO FOURNISSEURS (NO_FOURNISSEUR, SOCIETE, ADRESSE, VILLE, CODE_POSTAL, PAYS, TELEPHONE, FAX) VALUES ('F0001', 'Fournisseur X', '789 boulevard Liberté', 'Marseille', '13000', 'France', '0345678912', '0876543212');
INSERT INTO CATEGORIES (CODE_CATEGORIE, NOM_CATEGORIE, DESCRIPTION) VALUES ('CAT01', 'Électronique', 'Appareils et dispositifs électroniques.');
INSERT INTO EMPLOYES (NO_EMPLOYE, NOM, PRENOM, FONCTION, TITRE, DATE_NAISSANCE, DATE_EMBAUCHE, SALAIRE, PAYS, REGION) VALUES ('E0001', 'Dupont', 'Jean', 'Vendeur', 'M.', TO_DATE('1980-02-20','YYYY-MM-DD'), TO_DATE('2010-06-01','YYYY-MM-DD'), 2500, 'France', 'Île-de-France');